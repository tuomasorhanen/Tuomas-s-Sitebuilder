              ...
              return (
                <li key={item.slug.current}>
                  <Link
                    ...
                    className="block rounded py-2 pl-3 pr-4 text-gray-400 hover:bg-gray-700 hover:bg-transparent hover:text-white md:border-0 md:p-0 md:hover:bg-transparent md:hover:text-white"
                    aria-current="page">
                    {item.name}
                  </Link>
                </li>
