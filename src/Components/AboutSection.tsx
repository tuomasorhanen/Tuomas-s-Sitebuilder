...
const AboutSection = (props: IAbout) => {
  ...
  return (
    <div
      key={props._key}
      className="bg-gray-900 pb-16 lg:relative lg:z-10 lg:pb-0"
    >
      <div className="lg:mx-auto lg:grid lg:max-w-7xl lg:grid-cols-3 lg:gap-8 lg:px-8">
        <div className="relative lg:-my-8">
          <div
            aria-hidden="true"
            className="absolute inset-x-0 top-0 h-1/2 bg-gray-900 lg:hidden"
          />
          <div className="mx-auto max-w-md px-6 sm:max-w-3xl lg:h-full lg:p-0">
            ...
            <h2 className="mt-4 mb-16 hidden text-center text-4xl font-medium text-white lg:block">
              {title}
            </h2>
          </div>
        </div>
        <div className=" lg:col-span-2 lg:m-0 lg:pl-8">
          <div className="mx-auto max-w-md px-6 pt-8 sm:max-w-2xl lg:max-w-none lg:px-0 lg:py-12">
            <blockquote>
              <div>
                <h2 className="text-center text-3xl font-medium text-white lg:hidden">
                  {title}
                </h2>

                <p className="text-md mt-6 font-light text-white">
                  {description}
                </p>
              </div>
