  ...
  const serializers = {
    types: {
      block: props => {
        ...
        switch (style) {
          case 'h1':
            return <h1 className="text-5xl sm:text-6xl md:text-8xl pb-2 font-orbitron">{props.children}</h1>;
          case 'h2':
            return <h2 className="text-4xl sm:text-5xl md:text-6xl pb-2 font-orbitron">{props.children}</h2>;
          case 'h3':
            return <h3 className="text-2xl md:text-4xl pb-2 font-orbitron">{props.children}</h3>;
          case 'h4':
