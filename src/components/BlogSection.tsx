      ...
      <div className="col-start-1 col-end-13">
        <div className="mt-10 flex flex-wrap justify-center">
          <button
            ...
            className={`mx-2 my-2 rounded-full border border-white py-2 px-4 font-medium uppercase tracking-widest text-white transition duration-300 ease-in-out hover:bg-white hover:text-gray-900
          ...
          {categories.map(category => (
            <button
              ...
              className={`mx-2 my-2 rounded-full border border-white p-4 py-2 font-medium uppercase tracking-widest text-white transition duration-300 ease-in-out hover:bg-white hover:text-gray-900
